...
test('module.exports = function', t => {
  const m = loadModule(
    `${__dirname}/../fixtures/good-modules/module-exports-function.js`
  )
...
test('module.exports = {}', async t => {
  const m = loadModule(
    `${__dirname}/../fixtures/good-modules/module-exports-object.js`
  )
  t.is(typeof m, 'object')
  t.is(await m.hi(), 'hi')
})
...
test('async function', async t => {
  const m = loadModule(
    `${__dirname}/../fixtures/good-modules/async-function.js`
  )
  t.is(typeof m, 'object')
  t.is(await m.hi(), 'hi')
})
...
test('deals with dupes', async t => {
  ...
  const n = loadModule(
    `${__dirname}/../fixtures/good-modules/../good-modules/async-function.js`
  )
  t.is(m, n)
})
